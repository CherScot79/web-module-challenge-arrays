...
const twin31List = copy(originalFlavors);

console.log(twin31List);
...
function is31Flavors(lenArr){
    return(lenArr.length == 31);
...
function removeLastFlavor(thirtyOne){
   thirtyOne.pop();
   return thirtyOne;
}
...
function getFlavorByIndex(thirtyOne, i){
    return thirtyOne[i];
}
